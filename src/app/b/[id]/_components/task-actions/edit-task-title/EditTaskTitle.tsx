    ...
    <>
      {mode === 'default' && (
        <div className="flex w-full items-center gap-2">
          <h4 className="max-w-[80%] text-base font-semibold wrap-break-word break-all transition-colors">
            {title}
          </h4>
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid} className="flex-1">
                <Textarea
                  ...
                  className="bg-background focus-visible:ring-primary min-h-fit resize-none rounded-md border p-2 wrap-anywhere break-all shadow-sm transition-all focus-visible:ring-2"
                />
              </Field>
            )}
          />
